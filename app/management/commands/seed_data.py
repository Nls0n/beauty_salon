...
class Command(BaseCommand):
    help = "Генерация реалистичных тестовых данных для бьюти-салона"
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write("Начало генерации новых данных...")
